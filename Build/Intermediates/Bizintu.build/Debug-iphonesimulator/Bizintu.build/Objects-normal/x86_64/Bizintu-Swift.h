...
SWIFT_MODULE_NAMESPACE_PUSH("Bizintu")
@class UIWindow;
@class UIApplication;

SWIFT_CLASS("_TtC7Bizintu11AppDelegate")
...
SWIFT_CLASS("_TtC7Bizintu9IntroView")
...
SWIFT_CLASS("_TtC7Bizintu22RegisterMenuController")
@interface RegisterMenuController : UITableViewController <GIDSignInDelegate, GIDSignInUIDelegate>
- (IBAction)emailSignUp:(UIButton * _Nonnull)sender;
- (IBAction)googleSignUp:(UIButton * _Nonnull)sender;
- (IBAction)facebookSignUp:(UIButton * _Nonnull)sender;
- (IBAction)signUpWithTwitter:(UIButton * _Nonnull)sender;
